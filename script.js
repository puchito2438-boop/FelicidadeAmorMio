...
const reasons = [
  ...
  "Por cómo te ríes de tus propios chistes antes de terminarlos.",
  "Por ser tan fuerte incluso cuando crees que no lo eres.",
  "Por cuidar de todos los que quieres sin esperar nada a cambio.",
  "Por tu manera de ver la vida con tanta ilusión.",
  "Por escucharme siempre, incluso cuando no tengo mucho que decir.",
  "Por tu paciencia infinita conmigo.",
  "Por cada abrazo que me hace sentir en casa.",
  "Por tu curiosidad, que me enseña a mirar el mundo distinto.",
  "Por ser mi persona favorita para no hacer nada.",
  "Por tu manera de bailar cuando crees que nadie te ve.",
  "Por tu valentía para perseguir lo que quieres.",
  "Por tu ternura con todo el mundo, siempre.",
  "Por tu buen gusto: elegiste el azul celeste, el blanco y el rosa, ¡y acertaste!",
  "Por tu sentido del humor, que nunca falla.",
  "Por cómo te esfuerzas cada día por ser mejor persona.",
  "Por hacerme sentir tranquilo solo con estar cerca.",
  "Por tus ganas de aprender cosas nuevas.",
  "Por tu honestidad, aunque a veces duela.",
  "Por creer en mí incluso cuando yo no lo hago.",
  "Por cada plan pequeño que conviertes en un recuerdo enorme.",
  "Por tu forma de querer, tan sincera y tan tuya.",
  "Por ser, sin ninguna duda, la mejor razón para sonreír cada día."
];
